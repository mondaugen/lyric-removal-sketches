...
# this algorithm doesn't use threading as that doesn't work yet

# this algorithm finds peaks in horizontal projections of half the image so that
# we don't assume that lyrics are a straight line accross
